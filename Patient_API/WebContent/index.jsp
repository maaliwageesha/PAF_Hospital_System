    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6 hi-item">
                <div class="hs-icon">
                    <img src="./images/main/mainlayout/icons/map-marker.png" alt="">
                </div>
            ...
            <div class="col-lg-3 col-md-6 hi-item">
                <div class="hs-icon">
                    <img src="./images/main/mainlayout/icons/clock.png" alt="">
                </div>
                <div class="hi-content">
                    <h6>Opening Hours</h6>
            ...
            <div class="col-lg-3 col-md-6 hi-item">
                <div class="hs-icon">
                    <img src="./images/main/mainlayout/icons/phone.png" alt="">
                </div>
                <div class="hi-content">
                    <h6>+94 11 534561</h6>
                    <p>Call us now!</p>
            ...
            <div class="col-lg-3 col-md-6 hi-item">
                <div class="hs-icon">
                    <img src="./images/main/mainlayout/icons/calendar.png" alt="">
                </div>
                <div class="hi-content">
...
<section class="hero-section image-overlay">
    <div class="hero-slider owl-carousel">
        <!-- item -->
        <div class="hs-item set-bg text-white" data-setbg="./images/main/index/bg_doctor.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7">
                        <h2>Origins of Health care</h2>
        ...
        <!-- item -->
        <div class="hs-item set-bg text-white" data-setbg="./images/main/index/doctor_group.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7">
                        <h2>Best Team</h2>
                        <p>Health Care team originates in the work of the German physician Samuel Hahnemann (1755-1843), who
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 banner-text text-white">
                ...
                <a href="/PatientAPI/register.jsp" class="site-btn sb-light">Register</a>
            </div>
...
<section class="about-section spad">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <img src="./images/main/index/child.jpg" alt="">
            </div>
            <div class="col-lg-7 about-text">
                <h2>We Care About Your Health</h2>
                <p>We provide you valued service 24 hours to provide you with the best and most efficient service..</p>
            </div>
        </div>
    </div>
</section>
...
<!-- Facts section -->
<section class="facts-section set-bg" data-setbg="./images/main/index/facts-bg.jpg">
    <div class="container">
        <div class="row">
...
<section class="services-section spad">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 service">
                <div class="service-icon">
                    <img src="./images/main/index/svg-icons/002-first-aid-kit.svg" style="width: 50px;"
                        alt="">
                </div>
                <div class="service-content">
            ...
            <div class="col-lg-4 col-md-6 service">
                <div class="service-icon">
                    <img src="./images/main/index/svg-icons/003-stethoscope.svg" style="width: 50px;"
                        alt="">
                </div>
                <div class="service-content">
